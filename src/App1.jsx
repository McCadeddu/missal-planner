...
// Lista de momentos da Missa e Adoração
const sections = [
    "Ensaio de canto",
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <div className="flex flex-wrap gap-4">
                <button onClick={handleSave} className="px-6 py-3 bg-green-600 text-white rounded">
                    Salvar Lista
                </button>

                <button onClick={handleShare} className="px-6 py-3 bg-blue-600 text-white rounded">
                    Compartilhar
                </button>

                <button onClick={handlePrint} className="px-6 py-3 bg-gray-600 text-white rounded">
                    Imprimir
                </button>
